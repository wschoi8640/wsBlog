...
<body>
	...
	<div class="container">
		...
		<div class="col-lg-4">
			<div class="jumbotron" style="padding-top : 20px;" id="myJumbo">
				<form method="post" action="login.do">
					...
					<div class="form-group">
						<input type="password" class="form-control" placeholder="비밀번호" id="userPassword" maxlength="20" onkeypress="JavaScript:press()">
					</div>
					<button type="button" class="btn btn-primary form-control" onclick="loginFunction();">로그인</button>
					</br></br>
					<div id="naverIdLogin"></div>
				</form>
		</div>
		<div class="alert alert-warning" id="wrongPasswd" style="display: none;">
		...
		<div class="alert alert-danger" id="blankPasswd" style="display: none;">
