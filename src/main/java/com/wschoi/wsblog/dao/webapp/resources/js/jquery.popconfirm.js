    ...
    popConfirm: function (options) {
      ...
      return this.each(function () {
        ...
        self.popover({
          ...
          content: options.content + '<p class="button-group" style="margin-top: 10px; text-align: center;"><button type="button" class="btn btn-small btn-danger confirm-dialog-btn-confirm">' + options.yesBtn + '</button>&nbsp;<button type="button" class="btn btn-small confirm-dialog-btn-abort">' + options.noBtn + '</button> </p>'
        }).click(function (e) {
          if (last && last !== self) {
