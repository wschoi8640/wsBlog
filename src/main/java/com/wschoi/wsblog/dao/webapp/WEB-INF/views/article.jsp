...
<script src="https://dnjstjr.site/resources/js/jquery.popconfirm.js"></script>
...
<script type="text/javascript">
	function getArticleContent(){
		...
		$.ajax({
			type: "POST",
			url: "./getArticleContent/" + bbsID,
			success: function(data){
				if(data=="") return;
				addArticleContent(data.bbsTitle, data.userID, data.bbsDate, data.bbsContent);
			}
...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<a href="/bbs/${pageNumber}" class="btn btn-primary" id="btnList">목록</a>
			<c:choose>
				<c:when test="${userID eq bbsUserID}">	
					<a href="/update/${bbsID}" class="btn btn-primary">수정</a>
					<a href="doDelete/${bbsID}" id="delete" class="btn btn-primary">삭제</a>
				</c:when>
			</c:choose>
		</div>
	</div>
